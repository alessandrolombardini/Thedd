...
public interface ControllerShowMethods {
     ...
     * @param alliedParty
     *          the actors in the allied party
     * @param enemyParty
     *          the actors in the enemy party
     * @param action
     *          the action which needs a target
     */
    void showTargets(List<ActionActor> targetables,
                     List<ActionActor> alliedParty, 
                     List<ActionActor> enemyParty, 
                     Action action);
